...
import {mairie, cabinet, cabinetservices, secretariat, secretariatservices, direction, directionservices} from '../containers/mairie'
import {maire} from '../containers/presentationmaire'
import {conseilmunicipal,
    attributions,
/*     competences,
    detailscompetences, */
    municipalite,
    membresmunicipalite} from '../containers/conseilmunicipal'
              ...
              <Nav tabs>
                  ...
                  <NavItem>
                    <NavLink
                      ...
                      onClick={() => { toggle('4'); }}>
                      <p className="mytitle font-weight-bold">LES SERVICES DE LA MARIE</p>
                    </NavLink>
                  </NavItem>
                  <NavItem>
                    <NavLink
            ...
            {/*Contenu des Tabs*/}
              ...
              <TabContent activeTab={activeTab}>
                ...
                <TabPane tabId="1">
                  {
                    maire.map((text, key) => (
                      <p key={key} className="text-justify descriptn mt-3 mx-1 px-3">{text.info}</p>
                    ))
                  }
                </TabPane>
                ...
                <TabPane tabId="5">
                  ...
                  <Row className=" p-3">
                    ...
                    <Col sm="12">
                      <NavLink>
                        <h5 className="text-justify h5-responsive text-center mytitle"
                ...
                <TabPane tabId="6">
                  ...
                  {
                    membresmunicipalite.map((text, key) => (
                      <ul key={key} >
                        <li className="text-justify descriptn px-2 font-weight-bold">{text.info}</li>
                      </ul>
                    ))
                  }
                </TabPane>
